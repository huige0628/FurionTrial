<template>
    <div class="page-main">
        ...
        >
            ...
            <!-- 默认搜索项 -->
            <el-form-item>
                <el-input v-model="filter.name" placeholder="货币名称" clearable />
            </el-form-item>
            <el-form-item>
                <el-input v-model="filter.code" placeholder="国际代码" clearable />
            </el-form-item>
            <template slot="more">
                <!-- 更多搜索项 -->
            </template>
        ...
        <SimpleTable ref="table" :url="tableUrl" :filter="filter" :offset="10">
            ...
            <el-table-column prop="currencyCode" label="国际代码" />
    ...
    methods: {
        ...
        remove(row) {
            ...
            this.$confirm('确定要删除国家吗？', '删除', {
                ...
                .then(() => {
                    this.$api.post('api/baseinfo/currencyemove', ids).then(res => {
                        if (res.succeeded) {
